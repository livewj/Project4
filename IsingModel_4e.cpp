...
int main(int argc, char* argv[])
{
  ...
  // InitialTemp = 2.0, Finaltemp = 2.3, TempStep = 0.05
...
void WriteResultstoFile(int NSpins, int MCcycles, double temperature, vec ExpectationValues)
{
  ...
  ofile << setw(15) << setprecision(8) << E_ExpectationValues/NSpins/NSpins; //<E>
  ofile << setw(15) << setprecision(8) << Evariance/temperature/temperature; //Cv
  ofile << setw(15) << setprecision(8) << M_ExpectationValues/NSpins/NSpins; //<M>
  ofile << setw(15) << setprecision(8) << Mvariance/temperature;             //X
  ofile << setw(15) << setprecision(8) << Mabs_ExpectationValues/NSpins/NSpins << endl; //<|M|>
